...
export function buildPythonSolverArgs({
  ...
  if (ddddocrPresets != null) args.push('--ddddocr-presets', String(ddddocrPresets));
  if (ddddocrCoordinate != null) args.push('--ddddocr-coordinate', String(ddddocrCoordinate));
  if (ddddocrMinConfidence != null) args.push('--ddddocr-min-confidence', String(ddddocrMinConfidence));
  if (ddddocrDistanceRange != null) args.push('--ddddocr-distance-range', String(ddddocrDistanceRange));
  if (ddddocrBenchmarkJson != null) args.push('--ddddocr-benchmark-json', String(ddddocrBenchmarkJson));
  return args;
}
